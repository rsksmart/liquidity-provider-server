...
func TestPegout_InsertAndGetQuote(t *testing.T) {
	...
	hash := randomHash()
	created := newTestPegoutQuote(hash)
...
func TestPegout_GetQuote_NotFound(t *testing.T) {
	...
	got, err := pegoutRepo.GetQuote(ctx, randomHash())
	require.NoError(t, err)
	assert.Nil(t, got)
}
...
func TestPegout_GetPegoutCreationData_NotFound(t *testing.T) {
	...
	got := pegoutRepo.GetPegoutCreationData(ctx, randomHash())
...
func TestPegout_InsertAndGetRetainedQuote(t *testing.T) {
	...
	hash := randomHash()
	retained := newTestRetainedPegoutQuote(hash, quote.PegoutStateWaitingForDeposit)
...
func TestPegout_GetRetainedQuote_NotFound(t *testing.T) {
	...
	got, err := pegoutRepo.GetRetainedQuote(ctx, randomHash())
	require.NoError(t, err)
	assert.Nil(t, got)
}
...
func TestPegout_UpdateRetainedQuote_NotFound(t *testing.T) {
	...
	retained := newTestRetainedPegoutQuote(randomHash(), quote.PegoutStateSendPegoutSucceeded)
...
func TestPegout_UpdateRetainedQuotes_HappyPath(t *testing.T) {
	...
	h1 := randomHash()
	h2 := randomHash()
	r1 := newTestRetainedPegoutQuote(h1, quote.PegoutStateWaitingForDeposit)
	r2 := newTestRetainedPegoutQuote(h2, quote.PegoutStateWaitingForDeposit)
...
func TestPegout_UpdateRetainedQuotes_PartialFailure(t *testing.T) {
	...
	r1.State = quote.PegoutStateSendPegoutSucceeded
	r2.State = quote.PegoutStateSendPegoutSucceeded
	rNonExistent := newTestRetainedPegoutQuote(hNonExistent, quote.PegoutStateSendPegoutSucceeded)
...
func TestPegout_GetRetainedQuoteByState(t *testing.T) {
	...
	h2 := randomHash()
	h3 := randomHash()
	require.NoError(t, pegoutRepo.InsertRetainedQuote(ctx, newTestRetainedPegoutQuote(h1, quote.PegoutStateWaitingForDeposit)))
	require.NoError(t, pegoutRepo.InsertRetainedQuote(ctx, newTestRetainedPegoutQuote(h2, quote.PegoutStateSendPegoutSucceeded)))
	require.NoError(t, pegoutRepo.InsertRetainedQuote(ctx, newTestRetainedPegoutQuote(h3, quote.PegoutStateBtcReleased)))
...
func TestPegout_GetQuotesByState(t *testing.T) {
	...
	require.NoError(t, pegoutRepo.InsertQuote(ctx, q2))
	require.NoError(t, pegoutRepo.InsertRetainedQuote(ctx, newTestRetainedPegoutQuote(h1, quote.PegoutStateWaitingForDeposit)))
	require.NoError(t, pegoutRepo.InsertRetainedQuote(ctx, newTestRetainedPegoutQuote(h2, quote.PegoutStateSendPegoutFailed)))
...
func TestPegout_DeleteQuotes(t *testing.T) {
	...
	h1 := randomHash()
	h2 := randomHash()
	require.NoError(t, pegoutRepo.InsertQuote(ctx, newTestPegoutQuote(h1)))
	require.NoError(t, pegoutRepo.InsertQuote(ctx, newTestPegoutQuote(h2)))
	require.NoError(t, pegoutRepo.InsertRetainedQuote(ctx, newTestRetainedPegoutQuote(h1, quote.PegoutStateWaitingForDeposit)))
	require.NoError(t, pegoutRepo.InsertRetainedQuote(ctx, newTestRetainedPegoutQuote(h2, quote.PegoutStateSendPegoutSucceeded)))
...
func TestPegout_UpsertPegoutDeposit(t *testing.T) {
	...
	quoteHash := randomHash()
	deposit := newTestPegoutDeposit(txHash, quoteHash)
...
func TestPegout_UpsertPegoutDeposits(t *testing.T) {
	...
	d1 := newTestPegoutDeposit("0x"+randomHash(), randomHash())
	d2 := newTestPegoutDeposit("0x"+randomHash(), randomHash())
...
func TestPegout_GetRetainedQuotesForAddress(t *testing.T) {
	...
	r2 := newTestRetainedPegoutQuote(h2, quote.PegoutStateSendPegoutSucceeded)
	r2.OwnerAccountAddress = addr
	r3 := newTestRetainedPegoutQuote(h3, quote.PegoutStateWaitingForDeposit)
...
func TestPegout_GetRetainedQuotesInBatch(t *testing.T) {
	...
	r1 := newTestRetainedPegoutQuote(h1, quote.PegoutStateBridgeTxSucceeded)
	r1.BridgeRefundTxHash = releaseTx1
	r2 := newTestRetainedPegoutQuote(h2, quote.PegoutStateBridgeTxSucceeded)
	r2.BridgeRefundTxHash = releaseTx2
	r3 := newTestRetainedPegoutQuote(h3, quote.PegoutStateBridgeTxSucceeded)
