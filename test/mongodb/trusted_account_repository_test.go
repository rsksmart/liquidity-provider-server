...
func TestTrusted_AddAndGet(t *testing.T) {
	...
	account := newTestTrustedAccount("0xaaaa1111bbbb2222cccc3333dddd4444eeee5555")
...
func TestTrusted_AddDuplicate(t *testing.T) {
	...
	account := newTestTrustedAccount("0xdddd1111eeee2222ffff3333aaaa4444bbbb5555")
	err := trustedRepo.AddTrustedAccount(ctx, account)
	require.NoError(t, err)
...
func TestTrusted_GetAll(t *testing.T) {
	...
	require.NoError(t, trustedRepo.AddTrustedAccount(ctx, newTestTrustedAccount(addr1)))
	require.NoError(t, trustedRepo.AddTrustedAccount(ctx, newTestTrustedAccount(addr2)))
...
func TestTrusted_Update(t *testing.T) {
	...
	account := newTestTrustedAccount("0xeeee1111ffff2222aaaa3333bbbb4444cccc5555")
...
func TestTrusted_Update_NotFound(t *testing.T) {
	...
	account := newTestTrustedAccount("0xnonexistent000000000000000000000000000000")
	err := trustedRepo.UpdateTrustedAccount(ctx, account)
	require.ErrorIs(t, err, liquidity_provider.TrustedAccountNotFoundError)
}
...
func TestTrusted_Delete(t *testing.T) {
	...
	account := newTestTrustedAccount("0xffff1111aaaa2222bbbb3333cccc4444dddd5555")
	require.NoError(t, trustedRepo.AddTrustedAccount(ctx, account))
