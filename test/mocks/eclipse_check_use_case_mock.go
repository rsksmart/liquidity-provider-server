...
func (_m *EclipseCheckUseCaseMock) Run(ctx context.Context, nodeType entities.NodeType) error {
...
func (_c *EclipseCheckUseCaseMock_Run_Call) Run(run func(ctx context.Context, nodeType entities.NodeType)) *EclipseCheckUseCaseMock_Run_Call {
...
func (_c *EclipseCheckUseCaseMock_Run_Call) RunAndReturn(run func(context.Context, entities.NodeType) error) *EclipseCheckUseCaseMock_Run_Call {
	_c.Call.Return(run)
	return _c
}
