...
func (_m *PeginQuoteRepositoryMock) GetQuotesByHashesAndDate(ctx context.Context, hashes []string, startDate time.Time, endDate time.Time) ([]quote.PeginQuote, error) {
	...
	var r0 []quote.PeginQuote
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, time.Time, time.Time) ([]quote.PeginQuote, error)); ok {
		return rf(ctx, hashes, startDate, endDate)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []string, time.Time, time.Time) []quote.PeginQuote); ok {
...
// PeginQuoteRepositoryMock_GetQuotesByHashesAndDate_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetQuotesByHashesAndDate'
...
//   - startDate time.Time
//   - endDate time.Time
func (_e *PeginQuoteRepositoryMock_Expecter) GetQuotesByHashesAndDate(ctx interface{}, hashes interface{}, startDate interface{}, endDate interface{}) *PeginQuoteRepositoryMock_GetQuotesByHashesAndDate_Call {
	return &PeginQuoteRepositoryMock_GetQuotesByHashesAndDate_Call{Call: _e.mock.On("GetQuotesByHashesAndDate", ctx, hashes, startDate, endDate)}
}

func (_c *PeginQuoteRepositoryMock_GetQuotesByHashesAndDate_Call) Run(run func(ctx context.Context, hashes []string, startDate time.Time, endDate time.Time)) *PeginQuoteRepositoryMock_GetQuotesByHashesAndDate_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *PeginQuoteRepositoryMock_GetQuotesByHashesAndDate_Call) Return(_a0 []quote.PeginQuote, _a1 error) *PeginQuoteRepositoryMock_GetQuotesByHashesAndDate_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PeginQuoteRepositoryMock_GetQuotesByHashesAndDate_Call) RunAndReturn(run func(context.Context, []string, time.Time, time.Time) ([]quote.PeginQuote, error)) *PeginQuoteRepositoryMock_GetQuotesByHashesAndDate_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *PeginQuoteRepositoryMock) ListQuotesByDateRange(ctx context.Context, startDate time.Time, endDate time.Time, page int, perPage int) ([]quote.PeginQuoteWithRetained, int, error) {
	...
	var r1 int
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, time.Time, time.Time, int, int) ([]quote.PeginQuoteWithRetained, int, error)); ok {
		return rf(ctx, startDate, endDate, page, perPage)
	}
	if rf, ok := ret.Get(0).(func(context.Context, time.Time, time.Time, int, int) []quote.PeginQuoteWithRetained); ok {
...
//   - page int
//   - perPage int
func (_e *PeginQuoteRepositoryMock_Expecter) ListQuotesByDateRange(ctx interface{}, startDate interface{}, endDate interface{}, page interface{}, perPage interface{}) *PeginQuoteRepositoryMock_ListQuotesByDateRange_Call {
	return &PeginQuoteRepositoryMock_ListQuotesByDateRange_Call{Call: _e.mock.On("ListQuotesByDateRange", ctx, startDate, endDate, page, perPage)}
}

func (_c *PeginQuoteRepositoryMock_ListQuotesByDateRange_Call) Run(run func(ctx context.Context, startDate time.Time, endDate time.Time, page int, perPage int)) *PeginQuoteRepositoryMock_ListQuotesByDateRange_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *PeginQuoteRepositoryMock_ListQuotesByDateRange_Call) Return(_a0 []quote.PeginQuoteWithRetained, _a1 int, _a2 error) *PeginQuoteRepositoryMock_ListQuotesByDateRange_Call {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *PeginQuoteRepositoryMock_ListQuotesByDateRange_Call) RunAndReturn(run func(context.Context, time.Time, time.Time, int, int) ([]quote.PeginQuoteWithRetained, int, error)) *PeginQuoteRepositoryMock_ListQuotesByDateRange_Call {
	_c.Call.Return(run)
	return _c
}
