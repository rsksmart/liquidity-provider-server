...
// WatchRegistrationApproval provides a mock function with given fields: ctx, address
func (_m *DiscoveryContractMock) WatchRegistrationApproval(ctx context.Context, address string) (blockchain.RegistrationState, error) {
	ret := _m.Called(ctx, address)

	if len(ret) == 0 {
		panic("no return value specified for WatchRegistrationApproval")
	}

	var r0 blockchain.RegistrationState
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (blockchain.RegistrationState, error)); ok {
		return rf(ctx, address)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) blockchain.RegistrationState); ok {
		r0 = rf(ctx, address)
	} else {
		r0 = ret.Get(0).(blockchain.RegistrationState)
	}
...
// DiscoveryContractMock_WatchRegistrationApproval_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'WatchRegistrationApproval'
type DiscoveryContractMock_WatchRegistrationApproval_Call struct {
	*mock.Call
}

// WatchRegistrationApproval is a helper method to define mock.On call
//   - ctx context.Context
//   - address string
func (_e *DiscoveryContractMock_Expecter) WatchRegistrationApproval(ctx interface{}, address interface{}) *DiscoveryContractMock_WatchRegistrationApproval_Call {
	return &DiscoveryContractMock_WatchRegistrationApproval_Call{Call: _e.mock.On("WatchRegistrationApproval", ctx, address)}
}

func (_c *DiscoveryContractMock_WatchRegistrationApproval_Call) Run(run func(ctx context.Context, address string)) *DiscoveryContractMock_WatchRegistrationApproval_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *DiscoveryContractMock_WatchRegistrationApproval_Call) Return(_a0 blockchain.RegistrationState, _a1 error) *DiscoveryContractMock_WatchRegistrationApproval_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *DiscoveryContractMock_WatchRegistrationApproval_Call) RunAndReturn(run func(context.Context, string) (blockchain.RegistrationState, error)) *DiscoveryContractMock_WatchRegistrationApproval_Call {
	_c.Call.Return(run)
	return _c
}
