...
func (_m *RpcClientBindingMock) PeerCount(ctx context.Context) (uint64, error) {
	ret := _m.Called(ctx)
...
// RpcClientBindingMock_PeerCount_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PeerCount'
type RpcClientBindingMock_PeerCount_Call struct {
	*mock.Call
}

// PeerCount is a helper method to define mock.On call
//   - ctx context.Context
func (_e *RpcClientBindingMock_Expecter) PeerCount(ctx interface{}) *RpcClientBindingMock_PeerCount_Call {
	return &RpcClientBindingMock_PeerCount_Call{Call: _e.mock.On("PeerCount", ctx)}
}

func (_c *RpcClientBindingMock_PeerCount_Call) Run(run func(ctx context.Context)) *RpcClientBindingMock_PeerCount_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *RpcClientBindingMock_PeerCount_Call) Return(_a0 uint64, _a1 error) *RpcClientBindingMock_PeerCount_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RpcClientBindingMock_PeerCount_Call) RunAndReturn(run func(context.Context) (uint64, error)) *RpcClientBindingMock_PeerCount_Call {
	_c.Call.Return(run)
	return _c
}
