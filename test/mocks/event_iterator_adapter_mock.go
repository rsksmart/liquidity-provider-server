...
type EventIteratorAdapterMock[T interface{}] struct {
	mock.Mock
}

type EventIteratorAdapterMock_Expecter[T interface{}] struct {
	mock *mock.Mock
}
...
type EventIteratorAdapterMock_Close_Call[T interface{}] struct {
	*mock.Call
}
...
type EventIteratorAdapterMock_Error_Call[T interface{}] struct {
	*mock.Call
}
...
type EventIteratorAdapterMock_Event_Call[T interface{}] struct {
	*mock.Call
}
...
type EventIteratorAdapterMock_Next_Call[T interface{}] struct {
	*mock.Call
}
...
func NewEventIteratorAdapterMock[T interface{}](t interface {
	mock.TestingT
	Cleanup(func())
