...
func (_m *SessionBindingMock) WithTransaction(ctx context.Context, fn func(context.Context) (interface{}, error), opts ...options.Lister[options.TransactionOptions]) (interface{}, error) {
...
func (_c *SessionBindingMock_WithTransaction_Call) Run(run func(ctx context.Context, fn func(context.Context) (interface{}, error), opts ...options.Lister[options.TransactionOptions])) *SessionBindingMock_WithTransaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *SessionBindingMock_WithTransaction_Call) RunAndReturn(run func(context.Context, func(context.Context) (interface{}, error), ...options.Lister[options.TransactionOptions]) (interface{}, error)) *SessionBindingMock_WithTransaction_Call {
	_c.Call.Return(run)
	return _c
}
