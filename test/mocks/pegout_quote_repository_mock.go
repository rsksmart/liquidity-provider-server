...
func (_m *PegoutQuoteRepositoryMock) GetQuotes(ctx context.Context, criteria *mongo_interfaces.Criteria) ([]quote.PegoutQuote, error) {
	...
	var r0 []quote.PegoutQuote
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *mongo_interfaces.Criteria) ([]quote.PegoutQuote, error)); ok {
		return rf(ctx, criteria)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *mongo_interfaces.Criteria) []quote.PegoutQuote); ok {
		r0 = rf(ctx, criteria)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]quote.PegoutQuote)
...
func (_e *PegoutQuoteRepositoryMock_Expecter) GetQuotes(ctx interface{}, criteria interface{}) *PegoutQuoteRepositoryMock_GetQuotes_Call {
	return &PegoutQuoteRepositoryMock_GetQuotes_Call{Call: _e.mock.On("GetQuotes", ctx, criteria)}
}

func (_c *PegoutQuoteRepositoryMock_GetQuotes_Call) Run(run func(ctx context.Context, criteria *mongo_interfaces.Criteria)) *PegoutQuoteRepositoryMock_GetQuotes_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *PegoutQuoteRepositoryMock_GetQuotes_Call) RunAndReturn(run func(context.Context, *mongo_interfaces.Criteria) ([]quote.PegoutQuote, error)) *PegoutQuoteRepositoryMock_GetQuotes_Call {
	_c.Call.Return(run)
	return _c
}
