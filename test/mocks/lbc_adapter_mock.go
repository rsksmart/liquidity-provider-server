...
func (_m *LbcAdapterMock) RefundUserPegOut(opts *bind.TransactOpts, quoteHash [32]byte) (*types.Transaction, error) {
	ret := _m.Called(opts, quoteHash)
...
// LbcAdapterMock_RefundUserPegOut_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RefundUserPegOut'
type LbcAdapterMock_RefundUserPegOut_Call struct {
	*mock.Call
}
...
//   - opts *bind.TransactOpts
//   - quoteHash [32]byte
func (_e *LbcAdapterMock_Expecter) RefundUserPegOut(opts interface{}, quoteHash interface{}) *LbcAdapterMock_RefundUserPegOut_Call {
	return &LbcAdapterMock_RefundUserPegOut_Call{Call: _e.mock.On("RefundUserPegOut", opts, quoteHash)}
}

func (_c *LbcAdapterMock_RefundUserPegOut_Call) Run(run func(opts *bind.TransactOpts, quoteHash [32]byte)) *LbcAdapterMock_RefundUserPegOut_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *LbcAdapterMock_RefundUserPegOut_Call) Return(_a0 *types.Transaction, _a1 error) *LbcAdapterMock_RefundUserPegOut_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LbcAdapterMock_RefundUserPegOut_Call) RunAndReturn(run func(*bind.TransactOpts, [32]byte) (*types.Transaction, error)) *LbcAdapterMock_RefundUserPegOut_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *LbcAdapterMock) UpdateProvider(opts *bind.TransactOpts, _name string, _url string) (*types.Transaction, error) {
...
// LbcAdapterMock_UpdateProvider_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UpdateProvider'
type LbcAdapterMock_UpdateProvider_Call struct {
	*mock.Call
}
...
//   - _name string
//   - _url string
func (_e *LbcAdapterMock_Expecter) UpdateProvider(opts interface{}, _name interface{}, _url interface{}) *LbcAdapterMock_UpdateProvider_Call {
	return &LbcAdapterMock_UpdateProvider_Call{Call: _e.mock.On("UpdateProvider", opts, _name, _url)}
}

func (_c *LbcAdapterMock_UpdateProvider_Call) Run(run func(opts *bind.TransactOpts, _name string, _url string)) *LbcAdapterMock_UpdateProvider_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *LbcAdapterMock_UpdateProvider_Call) Return(_a0 *types.Transaction, _a1 error) *LbcAdapterMock_UpdateProvider_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *LbcAdapterMock_UpdateProvider_Call) RunAndReturn(run func(*bind.TransactOpts, string, string) (*types.Transaction, error)) *LbcAdapterMock_UpdateProvider_Call {
	_c.Call.Return(run)
	return _c
}
