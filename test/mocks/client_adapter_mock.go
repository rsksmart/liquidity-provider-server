...
func (_m *ClientAdapterMock) GetBlockHash(blockHeight int64) (*chainhash.Hash, error) {
...
// ClientAdapterMock_GetBlockHash_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetBlockHash'
type ClientAdapterMock_GetBlockHash_Call struct {
	*mock.Call
}

// GetBlockHash is a helper method to define mock.On call
//   - blockHeight int64
func (_e *ClientAdapterMock_Expecter) GetBlockHash(blockHeight interface{}) *ClientAdapterMock_GetBlockHash_Call {
	return &ClientAdapterMock_GetBlockHash_Call{Call: _e.mock.On("GetBlockHash", blockHeight)}
}

func (_c *ClientAdapterMock_GetBlockHash_Call) Run(run func(blockHeight int64)) *ClientAdapterMock_GetBlockHash_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int64))
	})
	return _c
...
func (_c *ClientAdapterMock_GetBlockHash_Call) Return(_a0 *chainhash.Hash, _a1 error) *ClientAdapterMock_GetBlockHash_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ClientAdapterMock_GetBlockHash_Call) RunAndReturn(run func(int64) (*chainhash.Hash, error)) *ClientAdapterMock_GetBlockHash_Call {
	_c.Call.Return(run)
	return _c
}

// GetBlockHeaderVerbose provides a mock function with given fields: blockHash
func (_m *ClientAdapterMock) GetBlockHeaderVerbose(blockHash *chainhash.Hash) (*btcjson.GetBlockHeaderVerboseResult, error) {
	ret := _m.Called(blockHash)
...
// ClientAdapterMock_GetBlockHeaderVerbose_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetBlockHeaderVerbose'
type ClientAdapterMock_GetBlockHeaderVerbose_Call struct {
	*mock.Call
}

// GetBlockHeaderVerbose is a helper method to define mock.On call
//   - blockHash *chainhash.Hash
func (_e *ClientAdapterMock_Expecter) GetBlockHeaderVerbose(blockHash interface{}) *ClientAdapterMock_GetBlockHeaderVerbose_Call {
	return &ClientAdapterMock_GetBlockHeaderVerbose_Call{Call: _e.mock.On("GetBlockHeaderVerbose", blockHash)}
}

func (_c *ClientAdapterMock_GetBlockHeaderVerbose_Call) Run(run func(blockHash *chainhash.Hash)) *ClientAdapterMock_GetBlockHeaderVerbose_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*chainhash.Hash))
	})
	return _c
...
func (_c *ClientAdapterMock_GetBlockHeaderVerbose_Call) Return(_a0 *btcjson.GetBlockHeaderVerboseResult, _a1 error) *ClientAdapterMock_GetBlockHeaderVerbose_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ClientAdapterMock_GetBlockHeaderVerbose_Call) RunAndReturn(run func(*chainhash.Hash) (*btcjson.GetBlockHeaderVerboseResult, error)) *ClientAdapterMock_GetBlockHeaderVerbose_Call {
	_c.Call.Return(run)
	return _c
}
...
// GetConnectionCount provides a mock function with no fields
func (_m *ClientAdapterMock) GetConnectionCount() (int64, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetConnectionCount")
	}
...
// ClientAdapterMock_GetConnectionCount_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetConnectionCount'
type ClientAdapterMock_GetConnectionCount_Call struct {
	*mock.Call
}

// GetConnectionCount is a helper method to define mock.On call
func (_e *ClientAdapterMock_Expecter) GetConnectionCount() *ClientAdapterMock_GetConnectionCount_Call {
	return &ClientAdapterMock_GetConnectionCount_Call{Call: _e.mock.On("GetConnectionCount")}
}

func (_c *ClientAdapterMock_GetConnectionCount_Call) Run(run func()) *ClientAdapterMock_GetConnectionCount_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *ClientAdapterMock_GetConnectionCount_Call) Return(_a0 int64, _a1 error) *ClientAdapterMock_GetConnectionCount_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ClientAdapterMock_GetConnectionCount_Call) RunAndReturn(run func() (int64, error)) *ClientAdapterMock_GetConnectionCount_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *ClientAdapterMock) RawRequest(method string, params []json.RawMessage) (json.RawMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, []json.RawMessage) (json.RawMessage, error)); ok {
...
// ClientAdapterMock_RawRequest_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RawRequest'
type ClientAdapterMock_RawRequest_Call struct {
	*mock.Call
}

// RawRequest is a helper method to define mock.On call
//   - method string
//   - params []json.RawMessage
func (_e *ClientAdapterMock_Expecter) RawRequest(method interface{}, params interface{}) *ClientAdapterMock_RawRequest_Call {
	return &ClientAdapterMock_RawRequest_Call{Call: _e.mock.On("RawRequest", method, params)}
}

func (_c *ClientAdapterMock_RawRequest_Call) Run(run func(method string, params []json.RawMessage)) *ClientAdapterMock_RawRequest_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ClientAdapterMock_RawRequest_Call) Return(_a0 json.RawMessage, _a1 error) *ClientAdapterMock_RawRequest_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ClientAdapterMock_RawRequest_Call) RunAndReturn(run func(string, []json.RawMessage) (json.RawMessage, error)) *ClientAdapterMock_RawRequest_Call {
	_c.Call.Return(run)
	return _c
}

// RescanBlockchain provides a mock function with given fields: startHeight
func (_m *ClientAdapterMock) RescanBlockchain(startHeight int64) (btcclient.RescanBlockchainResult, error) {
	ret := _m.Called(startHeight)

	if len(ret) == 0 {
		panic("no return value specified for RescanBlockchain")
	}

	var r0 btcclient.RescanBlockchainResult
	var r1 error
	if rf, ok := ret.Get(0).(func(int64) (btcclient.RescanBlockchainResult, error)); ok {
		return rf(startHeight)
	}
	if rf, ok := ret.Get(0).(func(int64) btcclient.RescanBlockchainResult); ok {
		r0 = rf(startHeight)
	} else {
		r0 = ret.Get(0).(btcclient.RescanBlockchainResult)
	}
...
// ClientAdapterMock_RescanBlockchain_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RescanBlockchain'
type ClientAdapterMock_RescanBlockchain_Call struct {
	*mock.Call
}

// RescanBlockchain is a helper method to define mock.On call
//   - startHeight int64
func (_e *ClientAdapterMock_Expecter) RescanBlockchain(startHeight interface{}) *ClientAdapterMock_RescanBlockchain_Call {
	return &ClientAdapterMock_RescanBlockchain_Call{Call: _e.mock.On("RescanBlockchain", startHeight)}
}

func (_c *ClientAdapterMock_RescanBlockchain_Call) Run(run func(startHeight int64)) *ClientAdapterMock_RescanBlockchain_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(int64))
	})
	return _c
...
func (_c *ClientAdapterMock_RescanBlockchain_Call) Return(_a0 btcclient.RescanBlockchainResult, _a1 error) *ClientAdapterMock_RescanBlockchain_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ClientAdapterMock_RescanBlockchain_Call) RunAndReturn(run func(int64) (btcclient.RescanBlockchainResult, error)) *ClientAdapterMock_RescanBlockchain_Call {
	_c.Call.Return(run)
	return _c
}
