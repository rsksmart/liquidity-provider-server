...
func (_m *GetAssetsReportUseCaseMock) Run(ctx context.Context) (reports.GetAssetsReportResult, error) {
	ret := _m.Called(ctx)
...
func (_c *GetAssetsReportUseCaseMock_Run_Call) Return(_a0 reports.GetAssetsReportResult, _a1 error) *GetAssetsReportUseCaseMock_Run_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *GetAssetsReportUseCaseMock_Run_Call) RunAndReturn(run func(context.Context) (reports.GetAssetsReportResult, error)) *GetAssetsReportUseCaseMock_Run_Call {
	_c.Call.Return(run)
	return _c
}
