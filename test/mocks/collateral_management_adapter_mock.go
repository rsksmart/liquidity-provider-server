...
func (_m *CollateralManagementAdapterMock) PauseStatus(opts *bind.CallOpts) (struct {
	IsPaused bool
	Reason   string
	Since    uint64
}, error) {
...
// CollateralManagementAdapterMock_PauseStatus_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PauseStatus'
type CollateralManagementAdapterMock_PauseStatus_Call struct {
	*mock.Call
}

// PauseStatus is a helper method to define mock.On call
//   - opts *bind.CallOpts
func (_e *CollateralManagementAdapterMock_Expecter) PauseStatus(opts interface{}) *CollateralManagementAdapterMock_PauseStatus_Call {
	return &CollateralManagementAdapterMock_PauseStatus_Call{Call: _e.mock.On("PauseStatus", opts)}
}

func (_c *CollateralManagementAdapterMock_PauseStatus_Call) Run(run func(opts *bind.CallOpts)) *CollateralManagementAdapterMock_PauseStatus_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*bind.CallOpts))
	})
	return _c
...
func (_c *CollateralManagementAdapterMock_PauseStatus_Call) Return(_a0 struct {
	IsPaused bool
	Reason   string
	Since    uint64
}, _a1 error) *CollateralManagementAdapterMock_PauseStatus_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *CollateralManagementAdapterMock_PauseStatus_Call) RunAndReturn(run func(*bind.CallOpts) (struct {
	IsPaused bool
	Reason   string
	Since    uint64
}, error)) *CollateralManagementAdapterMock_PauseStatus_Call {
	_c.Call.Return(run)
	return _c
}
