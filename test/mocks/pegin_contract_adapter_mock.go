...
func (_m *PeginContractAdapterMock) Withdraw(opts *bind.TransactOpts, amount *big.Int) (*types.Transaction, error) {
...
// PeginContractAdapterMock_Withdraw_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Withdraw'
type PeginContractAdapterMock_Withdraw_Call struct {
	*mock.Call
}
...
//   - opts *bind.TransactOpts
//   - amount *big.Int
func (_e *PeginContractAdapterMock_Expecter) Withdraw(opts interface{}, amount interface{}) *PeginContractAdapterMock_Withdraw_Call {
	return &PeginContractAdapterMock_Withdraw_Call{Call: _e.mock.On("Withdraw", opts, amount)}
}

func (_c *PeginContractAdapterMock_Withdraw_Call) Run(run func(opts *bind.TransactOpts, amount *big.Int)) *PeginContractAdapterMock_Withdraw_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *PeginContractAdapterMock_Withdraw_Call) Return(_a0 *types.Transaction, _a1 error) *PeginContractAdapterMock_Withdraw_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *PeginContractAdapterMock_Withdraw_Call) RunAndReturn(run func(*bind.TransactOpts, *big.Int) (*types.Transaction, error)) *PeginContractAdapterMock_Withdraw_Call {
	_c.Call.Return(run)
	return _c
}
