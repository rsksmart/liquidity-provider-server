...
// BitcoinWalletMock_GetTransaction_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetTransaction'
type BitcoinWalletMock_GetTransaction_Call struct {
	*mock.Call
}

// GetTransaction is a helper method to define mock.On call
//   - hash string
func (_e *BitcoinWalletMock_Expecter) GetTransaction(hash interface{}) *BitcoinWalletMock_GetTransaction_Call {
	return &BitcoinWalletMock_GetTransaction_Call{Call: _e.mock.On("GetTransaction", hash)}
}

func (_c *BitcoinWalletMock_GetTransaction_Call) Run(run func(hash string)) *BitcoinWalletMock_GetTransaction_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
// Send provides a mock function with given fields: address, value
func (_m *BitcoinWalletMock) Send(address string, value *entities.Wei) (blockchain.BitcoinTransactionResult, error) {
	...
	var r0 blockchain.BitcoinTransactionResult
	var r1 error
	if rf, ok := ret.Get(0).(func(string, *entities.Wei) (blockchain.BitcoinTransactionResult, error)); ok {
		return rf(address, value)
	}
	if rf, ok := ret.Get(0).(func(string, *entities.Wei) blockchain.BitcoinTransactionResult); ok {
		r0 = rf(address, value)
	} else {
		r0 = ret.Get(0).(blockchain.BitcoinTransactionResult)
	}
...
// BitcoinWalletMock_Send_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Send'
type BitcoinWalletMock_Send_Call struct {
	*mock.Call
}
...
//   - address string
//   - value *entities.Wei
func (_e *BitcoinWalletMock_Expecter) Send(address interface{}, value interface{}) *BitcoinWalletMock_Send_Call {
	return &BitcoinWalletMock_Send_Call{Call: _e.mock.On("Send", address, value)}
}

func (_c *BitcoinWalletMock_Send_Call) Run(run func(address string, value *entities.Wei)) *BitcoinWalletMock_Send_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string), args[1].(*entities.Wei))
	})
	return _c
...
func (_c *BitcoinWalletMock_Send_Call) Return(_a0 blockchain.BitcoinTransactionResult, _a1 error) *BitcoinWalletMock_Send_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *BitcoinWalletMock_Send_Call) RunAndReturn(run func(string, *entities.Wei) (blockchain.BitcoinTransactionResult, error)) *BitcoinWalletMock_Send_Call {
	_c.Call.Return(run)
	return _c
}

// SendWithOpReturn provides a mock function with given fields: address, value, opReturnContent
func (_m *BitcoinWalletMock) SendWithOpReturn(address string, value *entities.Wei, opReturnContent []byte) (blockchain.BitcoinTransactionResult, error) {
	ret := _m.Called(address, value, opReturnContent)
	...
	var r0 blockchain.BitcoinTransactionResult
	var r1 error
	if rf, ok := ret.Get(0).(func(string, *entities.Wei, []byte) (blockchain.BitcoinTransactionResult, error)); ok {
		return rf(address, value, opReturnContent)
	}
	if rf, ok := ret.Get(0).(func(string, *entities.Wei, []byte) blockchain.BitcoinTransactionResult); ok {
		r0 = rf(address, value, opReturnContent)
	} else {
		r0 = ret.Get(0).(blockchain.BitcoinTransactionResult)
	}
...
func (_c *BitcoinWalletMock_SendWithOpReturn_Call) Return(_a0 blockchain.BitcoinTransactionResult, _a1 error) *BitcoinWalletMock_SendWithOpReturn_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *BitcoinWalletMock_SendWithOpReturn_Call) RunAndReturn(run func(string, *entities.Wei, []byte) (blockchain.BitcoinTransactionResult, error)) *BitcoinWalletMock_SendWithOpReturn_Call {
	_c.Call.Return(run)
	return _c
}
