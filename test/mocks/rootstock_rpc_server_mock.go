...
func (_m *RootstockRpcServerMock) ChainId(ctx context.Context) (uint64, error) {
	ret := _m.Called(ctx)
...
// RootstockRpcServerMock_ChainId_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ChainId'
type RootstockRpcServerMock_ChainId_Call struct {
	*mock.Call
}

// ChainId is a helper method to define mock.On call
//   - ctx context.Context
func (_e *RootstockRpcServerMock_Expecter) ChainId(ctx interface{}) *RootstockRpcServerMock_ChainId_Call {
	return &RootstockRpcServerMock_ChainId_Call{Call: _e.mock.On("ChainId", ctx)}
}

func (_c *RootstockRpcServerMock_ChainId_Call) Run(run func(ctx context.Context)) *RootstockRpcServerMock_ChainId_Call {
...
func (_c *RootstockRpcServerMock_ChainId_Call) Return(_a0 uint64, _a1 error) *RootstockRpcServerMock_ChainId_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RootstockRpcServerMock_ChainId_Call) RunAndReturn(run func(context.Context) (uint64, error)) *RootstockRpcServerMock_ChainId_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *RootstockRpcServerMock) PeerCount(ctx context.Context) (uint64, error) {
	ret := _m.Called(ctx)
...
// RootstockRpcServerMock_PeerCount_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'PeerCount'
type RootstockRpcServerMock_PeerCount_Call struct {
	*mock.Call
}

// PeerCount is a helper method to define mock.On call
//   - ctx context.Context
func (_e *RootstockRpcServerMock_Expecter) PeerCount(ctx interface{}) *RootstockRpcServerMock_PeerCount_Call {
	return &RootstockRpcServerMock_PeerCount_Call{Call: _e.mock.On("PeerCount", ctx)}
}

func (_c *RootstockRpcServerMock_PeerCount_Call) Run(run func(ctx context.Context)) *RootstockRpcServerMock_PeerCount_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context))
	})
	return _c
...
func (_c *RootstockRpcServerMock_PeerCount_Call) Return(_a0 uint64, _a1 error) *RootstockRpcServerMock_PeerCount_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RootstockRpcServerMock_PeerCount_Call) RunAndReturn(run func(context.Context) (uint64, error)) *RootstockRpcServerMock_PeerCount_Call {
	_c.Call.Return(run)
	return _c
}
