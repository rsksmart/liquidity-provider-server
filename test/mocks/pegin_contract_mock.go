...
func (_m *PeginContractMock) RequestPegIn(params blockchain.RequestPegInParams) (blockchain.RequestPegInResult, error) {
	ret := _m.Called(params)
	...
	var r0 blockchain.RequestPegInResult
	var r1 error
	if rf, ok := ret.Get(0).(func(blockchain.RequestPegInParams) (blockchain.RequestPegInResult, error)); ok {
		return rf(params)
	}
	if rf, ok := ret.Get(0).(func(blockchain.RequestPegInParams) blockchain.RequestPegInResult); ok {
		r0 = rf(params)
	} else {
		r0 = ret.Get(0).(blockchain.RequestPegInResult)
	}
...
func (_c *PeginContractMock_RequestPegIn_Call) Return(_a0 blockchain.RequestPegInResult, _a1 error) *PeginContractMock_RequestPegIn_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
