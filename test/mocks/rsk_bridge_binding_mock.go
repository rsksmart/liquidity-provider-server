...
func (_m *RskBridgeBindingMock) FilterBatchPegoutCreated(opts *bind.FilterOpts, btcTxHash [][32]byte) (*bindings.RskBridgeBatchPegoutCreatedIterator, error) {
...
// RskBridgeBindingMock_FilterBatchPegoutCreated_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'FilterBatchPegoutCreated'
type RskBridgeBindingMock_FilterBatchPegoutCreated_Call struct {
	*mock.Call
}
...
//   - btcTxHash [][32]byte
func (_e *RskBridgeBindingMock_Expecter) FilterBatchPegoutCreated(opts interface{}, btcTxHash interface{}) *RskBridgeBindingMock_FilterBatchPegoutCreated_Call {
	return &RskBridgeBindingMock_FilterBatchPegoutCreated_Call{Call: _e.mock.On("FilterBatchPegoutCreated", opts, btcTxHash)}
}

func (_c *RskBridgeBindingMock_FilterBatchPegoutCreated_Call) Run(run func(opts *bind.FilterOpts, btcTxHash [][32]byte)) *RskBridgeBindingMock_FilterBatchPegoutCreated_Call {
...
func (_c *RskBridgeBindingMock_FilterBatchPegoutCreated_Call) Return(_a0 *bindings.RskBridgeBatchPegoutCreatedIterator, _a1 error) *RskBridgeBindingMock_FilterBatchPegoutCreated_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RskBridgeBindingMock_FilterBatchPegoutCreated_Call) RunAndReturn(run func(*bind.FilterOpts, [][32]byte) (*bindings.RskBridgeBatchPegoutCreatedIterator, error)) *RskBridgeBindingMock_FilterBatchPegoutCreated_Call {
	_c.Call.Return(run)
	return _c
}
