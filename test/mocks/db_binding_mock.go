...
func (_m *DbBindingMock) Collection(name string, opts ...options.Lister[options.CollectionOptions]) mongo.CollectionBinding {
	...
	if rf, ok := ret.Get(0).(func(string, ...options.Lister[options.CollectionOptions]) mongo.CollectionBinding); ok {
		r0 = rf(name, opts...)
	} else {
		if ret.Get(0) != nil {
...
func (_c *DbBindingMock_Collection_Call) Run(run func(name string, opts ...options.Lister[options.CollectionOptions])) *DbBindingMock_Collection_Call {
...
func (_c *DbBindingMock_Collection_Call) RunAndReturn(run func(string, ...options.Lister[options.CollectionOptions]) mongo.CollectionBinding) *DbBindingMock_Collection_Call {
	_c.Call.Return(run)
	return _c
}
