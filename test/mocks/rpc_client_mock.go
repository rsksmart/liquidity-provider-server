...
func (_m *RpcClientMock) GetConnectionCount() (int64, error) {
	ret := _m.Called()
...
// RpcClientMock_GetConnectionCount_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetConnectionCount'
type RpcClientMock_GetConnectionCount_Call struct {
	*mock.Call
}

// GetConnectionCount is a helper method to define mock.On call
func (_e *RpcClientMock_Expecter) GetConnectionCount() *RpcClientMock_GetConnectionCount_Call {
	return &RpcClientMock_GetConnectionCount_Call{Call: _e.mock.On("GetConnectionCount")}
}

func (_c *RpcClientMock_GetConnectionCount_Call) Run(run func()) *RpcClientMock_GetConnectionCount_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *RpcClientMock_GetConnectionCount_Call) Return(_a0 int64, _a1 error) *RpcClientMock_GetConnectionCount_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RpcClientMock_GetConnectionCount_Call) RunAndReturn(run func() (int64, error)) *RpcClientMock_GetConnectionCount_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *RpcClientMock) RawRequest(method string, params []json.RawMessage) (json.RawMessage, error) {
...
// RpcClientMock_RawRequest_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'RawRequest'
type RpcClientMock_RawRequest_Call struct {
	*mock.Call
}
...
func (_e *RpcClientMock_Expecter) RawRequest(method interface{}, params interface{}) *RpcClientMock_RawRequest_Call {
	return &RpcClientMock_RawRequest_Call{Call: _e.mock.On("RawRequest", method, params)}
}

func (_c *RpcClientMock_RawRequest_Call) Run(run func(method string, params []json.RawMessage)) *RpcClientMock_RawRequest_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *RpcClientMock_RawRequest_Call) Return(_a0 json.RawMessage, _a1 error) *RpcClientMock_RawRequest_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *RpcClientMock_RawRequest_Call) RunAndReturn(run func(string, []json.RawMessage) (json.RawMessage, error)) *RpcClientMock_RawRequest_Call {
	_c.Call.Return(run)
	return _c
}
