...
| `MANAGEMENT_ENCRYPTION_KEY` | AES-256-GCM key for the Management API session cookie. Is mandatory if the Management API is enabled. Must be a 32 bytes hex string. | `9f86d081884c7d659a2feaa0c55ad015a3bf4f1b2b0b822cd15d6c15b0f00a08` | NO |
