...
| `ENABLE_MANAGEMENT_UI_NEXT` | Whether to enable the embedded Vite Management UI under `/management/next/*`. Requires `ENABLE_MANAGEMENT_API=true`. If not provided, the default value will be `false`. | `true` or `false` | NO |
