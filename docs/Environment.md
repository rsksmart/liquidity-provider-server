...
| `PAUSE_REGISTRY_ADDRESS` | Pause registry deployed on the active Rootstock network. Used to read pause level and pause status. | `0x0000000000000000000000000000000000000000` | YES |
