...
| `USE_RETIRING_FEDERATION` | Wether to use the retiring federation instead of the active federation or not. This is only used for testing purposes and should not be set to true | false | NO |
