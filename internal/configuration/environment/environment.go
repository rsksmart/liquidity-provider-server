...
type RskEnv struct {
	...
	// Commit-first peg-in (DoS-removal redesign, EPICs E1/E2/E5). Optional: when unset, the
	// PegInAddressRegistry discovery watcher is not started and LPS keeps the legacy quote path.
