...
func TestSetGeneralConfigHandler_Success(t *testing.T) {
...
func TestSetGeneralConfigHandler_RequestErrors(t *testing.T) {
...
func TestSetGeneralConfigHandler_ConfirmationsValidation(t *testing.T) {
...
func TestSetGeneralConfigHandler_MaxLiquidityValidation(t *testing.T) {
...
func TestSetGeneralConfigHandler_ReimbursementWindowBlocksValidation(t *testing.T) {
...
func TestSetGeneralConfigHandler_ExcessToleranceRequiredFields(t *testing.T) {
...
func TestSetGeneralConfigHandler_ExcessToleranceValueValidation(t *testing.T) {
