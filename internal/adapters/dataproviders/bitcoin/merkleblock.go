// IMPORTANT:
// This file is a partial copy of github.com/btcsuite/btcd/btcutil/bloom/merkleblock.go.
// The rationale to make this copy is that the original bloom.NewMerkleBlock only constructs
// the blocks without the witness data (line 100 of the mentioned file) and that function
// uses an unexported structure which is wire.merkleBlock, therefore, this copy is necessary
// to make a modification to the original function to construct the merkle blocks using the
// witness data (line 46 of this file).
...
func NewMerkleBlock(block *btcutil.Block, filter *bloom.Filter, witness bool) (*wire.MsgMerkleBlock, []uint32) {
