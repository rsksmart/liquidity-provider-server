...
func (_RskBridge *RskBridgeCaller) HasBtcBlockCoinbaseTransactionInformation(opts *bind.CallOpts, blockHash [32]byte) (bool, error) {
	var out []interface{}
	err := _RskBridge.contract.Call(opts, &out, "hasBtcBlockCoinbaseTransactionInformation", blockHash)
...
//
// Solidity: function hasBtcBlockCoinbaseTransactionInformation(bytes32 blockHash) view returns(bool)
func (_RskBridge *RskBridgeSession) HasBtcBlockCoinbaseTransactionInformation(blockHash [32]byte) (bool, error) {
	return _RskBridge.Contract.HasBtcBlockCoinbaseTransactionInformation(&_RskBridge.CallOpts, blockHash)
}

// HasBtcBlockCoinbaseTransactionInformation is a free data retrieval call binding the contract method 0x253b944b.
//
// Solidity: function hasBtcBlockCoinbaseTransactionInformation(bytes32 blockHash) view returns(bool)
func (_RskBridge *RskBridgeCallerSession) HasBtcBlockCoinbaseTransactionInformation(blockHash [32]byte) (bool, error) {
	return _RskBridge.Contract.HasBtcBlockCoinbaseTransactionInformation(&_RskBridge.CallOpts, blockHash)
}
...
// RskBridgeBatchPegoutCreatedIterator is returned from FilterBatchPegoutCreated and is used to iterate over the raw logs and unpacked data for BatchPegoutCreated events raised by the RskBridge contract.
type RskBridgeBatchPegoutCreatedIterator struct {
	Event *RskBridgeBatchPegoutCreated // Event containing the contract specifics and raw log
...
func (it *RskBridgeBatchPegoutCreatedIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(RskBridgeBatchPegoutCreated)
...
func (it *RskBridgeBatchPegoutCreatedIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *RskBridgeBatchPegoutCreatedIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// RskBridgeBatchPegoutCreated represents a BatchPegoutCreated event raised by the RskBridge contract.
...
// FilterBatchPegoutCreated is a free log retrieval operation binding the contract event 0x483d0191cc4e784b04a41f6c4801a0766b43b1fdd0b9e3e6bfdca74e5b05c2eb.
//
// Solidity: event batch_pegout_created(bytes32 indexed btcTxHash, bytes releaseRskTxHashes)
func (_RskBridge *RskBridgeFilterer) FilterBatchPegoutCreated(opts *bind.FilterOpts, btcTxHash [][32]byte) (*RskBridgeBatchPegoutCreatedIterator, error) {

	var btcTxHashRule []interface{}
	for _, btcTxHashItem := range btcTxHash {
		btcTxHashRule = append(btcTxHashRule, btcTxHashItem)
	}

	logs, sub, err := _RskBridge.contract.FilterLogs(opts, "batch_pegout_created", btcTxHashRule)
	if err != nil {
		return nil, err
	}
	return &RskBridgeBatchPegoutCreatedIterator{contract: _RskBridge.contract, event: "batch_pegout_created", logs: logs, sub: sub}, nil
}

// WatchBatchPegoutCreated is a free log subscription operation binding the contract event 0x483d0191cc4e784b04a41f6c4801a0766b43b1fdd0b9e3e6bfdca74e5b05c2eb.
//
// Solidity: event batch_pegout_created(bytes32 indexed btcTxHash, bytes releaseRskTxHashes)
func (_RskBridge *RskBridgeFilterer) WatchBatchPegoutCreated(opts *bind.WatchOpts, sink chan<- *RskBridgeBatchPegoutCreated, btcTxHash [][32]byte) (event.Subscription, error) {
	...
	logs, sub, err := _RskBridge.contract.WatchLogs(opts, "batch_pegout_created", btcTxHashRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(RskBridgeBatchPegoutCreated)
				if err := _RskBridge.contract.UnpackLog(event, "batch_pegout_created", log); err != nil {
					return err
				}
				event.Raw = log
...
// ParseBatchPegoutCreated is a log parse operation binding the contract event 0x483d0191cc4e784b04a41f6c4801a0766b43b1fdd0b9e3e6bfdca74e5b05c2eb.
//
// Solidity: event batch_pegout_created(bytes32 indexed btcTxHash, bytes releaseRskTxHashes)
func (_RskBridge *RskBridgeFilterer) ParseBatchPegoutCreated(log types.Log) (*RskBridgeBatchPegoutCreated, error) {
	event := new(RskBridgeBatchPegoutCreated)
	if err := _RskBridge.contract.UnpackLog(event, "batch_pegout_created", log); err != nil {
		return nil, err
	}
