...
func TestGetPegoutReportUseCase_Run(t *testing.T) {
	...
	pegoutQuoteRepository.On("GetRetainedQuoteByState", ctx, quote.PegoutStateRefundPegOutSucceeded, quote.PegoutStateBridgeTxSucceeded, quote.PegoutStateBtcReleased).
	...
	useCase := reports.NewGetPegoutReportUseCase(pegoutQuoteRepository)
