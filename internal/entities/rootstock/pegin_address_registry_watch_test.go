...
func TestNewPegInAddressRegistryWatch(t *testing.T) {
	before := time.Now().UTC().Add(-time.Second)
	watch := rootstock.NewPegInAddressRegistryWatch("0xhash", 3, 101, "0xrsk", "0xregistrant", [32]byte{1})
...
func TestPegInAddressRegistryWatch_MarkUnsupportedEncoding(t *testing.T) {
	watch := rootstock.NewPegInAddressRegistryWatch("0xhash", 1, 1, "0xrsk", "0xregistrant", [32]byte{})
...
func TestPegInAddressRegistryWatch_MarkImported(t *testing.T) {
	watch := rootstock.NewPegInAddressRegistryWatch("0xhash", 1, 1, "0xrsk", "0xregistrant", [32]byte{})
	watch.LastError = "previous"
	watch.MarkImported()
...
func TestPegInAddressRegistryWatch_RecordError(t *testing.T) {
	watch := rootstock.NewPegInAddressRegistryWatch("0xhash", 1, 1, "0xrsk", "0xregistrant", [32]byte{})
