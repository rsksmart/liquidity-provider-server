...
//
// Solidity: function getPegOutProcessedQuote(bytes32 quoteHash) view returns((uint256,uint8))
func (_LiquidityBridgeContract *LiquidityBridgeContractCaller) GetPegOutProcessedQuote(opts *bind.CallOpts, quoteHash [32]byte) (LiquidityBridgeContractPegOutQuoteState, error) {
	var out []interface{}
...
//
// Solidity: function getPegOutProcessedQuote(bytes32 quoteHash) view returns((uint256,uint8))
func (_LiquidityBridgeContract *LiquidityBridgeContractSession) GetPegOutProcessedQuote(quoteHash [32]byte) (LiquidityBridgeContractPegOutQuoteState, error) {
...
//
// Solidity: function getPegOutProcessedQuote(bytes32 quoteHash) view returns((uint256,uint8))
func (_LiquidityBridgeContract *LiquidityBridgeContractCallerSession) GetPegOutProcessedQuote(quoteHash [32]byte) (LiquidityBridgeContractPegOutQuoteState, error) {
	return _LiquidityBridgeContract.Contract.GetPegOutProcessedQuote(&_LiquidityBridgeContract.CallOpts, quoteHash)
}
...
// DepositPegout is a paid mutator transaction binding the contract method 0x9bc500f7.
//
// Solidity: function depositPegout(bytes32 quoteHash) payable returns()
func (_LiquidityBridgeContract *LiquidityBridgeContractTransactor) DepositPegout(opts *bind.TransactOpts, quoteHash [32]byte) (*types.Transaction, error) {
	return _LiquidityBridgeContract.contract.Transact(opts, "depositPegout", quoteHash)
}

// DepositPegout is a paid mutator transaction binding the contract method 0x9bc500f7.
//
// Solidity: function depositPegout(bytes32 quoteHash) payable returns()
func (_LiquidityBridgeContract *LiquidityBridgeContractSession) DepositPegout(quoteHash [32]byte) (*types.Transaction, error) {
	return _LiquidityBridgeContract.Contract.DepositPegout(&_LiquidityBridgeContract.TransactOpts, quoteHash)
}

// DepositPegout is a paid mutator transaction binding the contract method 0x9bc500f7.
//
// Solidity: function depositPegout(bytes32 quoteHash) payable returns()
func (_LiquidityBridgeContract *LiquidityBridgeContractTransactorSession) DepositPegout(quoteHash [32]byte) (*types.Transaction, error) {
	return _LiquidityBridgeContract.Contract.DepositPegout(&_LiquidityBridgeContract.TransactOpts, quoteHash)
}
...
func (_LiquidityBridgeContract *LiquidityBridgeContractTransactor) SetProviderStatus(opts *bind.TransactOpts, providerId *big.Int, status bool) (*types.Transaction, error) {
	return _LiquidityBridgeContract.contract.Transact(opts, "setProviderStatus", providerId, status)
}

// SetProviderStatus is a paid mutator transaction binding the contract method 0x72cbf4e8.
//
// Solidity: function setProviderStatus(uint256 providerId, bool status) returns()
func (_LiquidityBridgeContract *LiquidityBridgeContractSession) SetProviderStatus(providerId *big.Int, status bool) (*types.Transaction, error) {
	return _LiquidityBridgeContract.Contract.SetProviderStatus(&_LiquidityBridgeContract.TransactOpts, providerId, status)
}

// SetProviderStatus is a paid mutator transaction binding the contract method 0x72cbf4e8.
//
// Solidity: function setProviderStatus(uint256 providerId, bool status) returns()
func (_LiquidityBridgeContract *LiquidityBridgeContractTransactorSession) SetProviderStatus(providerId *big.Int, status bool) (*types.Transaction, error) {
	return _LiquidityBridgeContract.Contract.SetProviderStatus(&_LiquidityBridgeContract.TransactOpts, providerId, status)
}
