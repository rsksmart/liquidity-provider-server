...
//
// Solidity: function getPegOutProcessedQuote(bytes32 quoteHash) view returns((uint256,uint8,bool))
...
//
// Solidity: function register(string _name, uint256 _fee, uint256 _quoteExpiration, uint256 _acceptedQuoteExpiration, uint256 _minTransactionValue, uint256 _maxTransactionValue, string _apiBaseUrl, bool _status, string _providerType) payable returns(uint256)
