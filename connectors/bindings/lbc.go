...
// QuotesPegOutQuoteState is an auto generated low-level Go binding around an user-defined struct.
type QuotesPegOutQuoteState struct {
...
func (_LiquidityBridgeContract *LiquidityBridgeContractCaller) GetPegOutQuoteState(opts *bind.CallOpts, quoteHash [32]byte) (QuotesPegOutQuoteState, error) {
	var out []interface{}
	err := _LiquidityBridgeContract.contract.Call(opts, &out, "getPegOutQuoteState", quoteHash)

	if err != nil {
		return *new(QuotesPegOutQuoteState), err
	}

	out0 := *abi.ConvertType(out[0], new(QuotesPegOutQuoteState)).(*QuotesPegOutQuoteState)
...
//
// Solidity: function getPegOutQuoteState(bytes32 quoteHash) view returns((uint256,uint8,bool))
func (_LiquidityBridgeContract *LiquidityBridgeContractSession) GetPegOutQuoteState(quoteHash [32]byte) (QuotesPegOutQuoteState, error) {
...
//
// Solidity: function getPegOutQuoteState(bytes32 quoteHash) view returns((uint256,uint8,bool))
func (_LiquidityBridgeContract *LiquidityBridgeContractCallerSession) GetPegOutQuoteState(quoteHash [32]byte) (QuotesPegOutQuoteState, error) {
	return _LiquidityBridgeContract.Contract.GetPegOutQuoteState(&_LiquidityBridgeContract.CallOpts, quoteHash)
}
...
func (_LiquidityBridgeContract *LiquidityBridgeContractTransactor) RefundPegOut(opts *bind.TransactOpts, quote QuotesPegOutQuote, btcTxHash []byte, btcBlockHeaderHash [32]byte, partialMerkleTree *big.Int, merkleBranchHashes [][32]byte) (*types.Transaction, error) {
...
//
// Solidity: function refundPegOut((address,address,bytes,address,bytes,uint256,uint256,int64,bytes,uint32,uint256,uint32,uint32,uint16,uint16,uint32,uint32,uint32) quote, bytes32 btcTxHash, bytes32 btcBlockHeaderHash, uint256 partialMerkleTree, bytes32[] merkleBranchHashes) returns()
func (_LiquidityBridgeContract *LiquidityBridgeContractSession) RefundPegOut(quote QuotesPegOutQuote, btcTxHash []byte, btcBlockHeaderHash [32]byte, partialMerkleTree *big.Int, merkleBranchHashes [][32]byte) (*types.Transaction, error) {
...
//
// Solidity: function refundPegOut((address,address,bytes,address,bytes,uint256,uint256,int64,bytes,uint32,uint256,uint32,uint32,uint16,uint16,uint32,uint32,uint32) quote, bytes32 btcTxHash, bytes32 btcBlockHeaderHash, uint256 partialMerkleTree, bytes32[] merkleBranchHashes) returns()
func (_LiquidityBridgeContract *LiquidityBridgeContractTransactorSession) RefundPegOut(quote QuotesPegOutQuote, btcTxHash []byte, btcBlockHeaderHash [32]byte, partialMerkleTree *big.Int, merkleBranchHashes [][32]byte) (*types.Transaction, error) {
	return _LiquidityBridgeContract.Contract.RefundPegOut(&_LiquidityBridgeContract.TransactOpts, quote, btcTxHash, btcBlockHeaderHash, partialMerkleTree, merkleBranchHashes)
}
...
func (_LiquidityBridgeContract *LiquidityBridgeContractTransactor) RegisterPegOut(opts *bind.TransactOpts, quote QuotesPegOutQuote, signature []byte) (*types.Transaction, error) {
...
//
// Solidity: function registerPegOut((address,address,bytes,address,bytes,uint256,uint256,int64,bytes,uint32,uint256,uint32,uint32,uint16,uint16,uint32,uint32,uint32) quote, bytes signature) returns()
func (_LiquidityBridgeContract *LiquidityBridgeContractSession) RegisterPegOut(quote QuotesPegOutQuote, signature []byte) (*types.Transaction, error) {
...
//
// Solidity: function registerPegOut((address,address,bytes,address,bytes,uint256,uint256,int64,bytes,uint32,uint256,uint32,uint32,uint16,uint16,uint32,uint32,uint32) quote, bytes signature) returns()
func (_LiquidityBridgeContract *LiquidityBridgeContractTransactorSession) RegisterPegOut(quote QuotesPegOutQuote, signature []byte) (*types.Transaction, error) {
	return _LiquidityBridgeContract.Contract.RegisterPegOut(&_LiquidityBridgeContract.TransactOpts, quote, signature)
}
