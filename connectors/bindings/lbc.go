...
func (_LiquidityBridgeContract *LiquidityBridgeContractTransactor) DepositPegout(opts *bind.TransactOpts, quote LiquidityBridgeContractPegOutQuote) (*types.Transaction, error) {
...
//
// Solidity: function depositPegout((address,address,bytes,address,bytes,uint256,uint256,int64,bytes,uint32,uint256,uint32,uint32,uint16,uint16,uint32,uint32,uint32) quote) payable returns()
func (_LiquidityBridgeContract *LiquidityBridgeContractSession) DepositPegout(quote LiquidityBridgeContractPegOutQuote) (*types.Transaction, error) {
...
//
// Solidity: function depositPegout((address,address,bytes,address,bytes,uint256,uint256,int64,bytes,uint32,uint256,uint32,uint32,uint16,uint16,uint32,uint32,uint32) quote) payable returns()
func (_LiquidityBridgeContract *LiquidityBridgeContractTransactorSession) DepositPegout(quote LiquidityBridgeContractPegOutQuote) (*types.Transaction, error) {
	return _LiquidityBridgeContract.Contract.DepositPegout(&_LiquidityBridgeContract.TransactOpts, quote)
}
