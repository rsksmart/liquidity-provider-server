...
type LiquidityProviderLBC struct {
	id       uint
...
func (_LBC *LBCCaller) GetProviders(opts *bind.CallOpts) ([]*LiquidityProviderLBC, error) {
	...
	if err != nil {
		return *new([]*LiquidityProviderLBC), err
	}

	out0 := *abi.ConvertType(out[0], new([]*LiquidityProviderLBC)).(*[]*LiquidityProviderLBC)
