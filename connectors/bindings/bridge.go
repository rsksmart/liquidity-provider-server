...
// GetActiveRedeemScript is a free data retrieval call binding the contract method 0x53a455ac.
//
// Solidity: function getActiveRedeemScript() view returns(bytes)
func (_RskBridge *RskBridgeCaller) GetActiveRedeemScript(opts *bind.CallOpts) ([]byte, error) {
	var out []interface{}
	err := _RskBridge.contract.Call(opts, &out, "getActiveRedeemScript")
...
//
// Solidity: function getActiveRedeemScript() view returns(bytes)
func (_RskBridge *RskBridgeSession) GetActiveRedeemScript() ([]byte, error) {
	return _RskBridge.Contract.GetActiveRedeemScript(&_RskBridge.CallOpts)
}

// GetActiveRedeemScript is a free data retrieval call binding the contract method 0x53a455ac.
//
// Solidity: function getActiveRedeemScript() view returns(bytes)
func (_RskBridge *RskBridgeCallerSession) GetActiveRedeemScript() ([]byte, error) {
	return _RskBridge.Contract.GetActiveRedeemScript(&_RskBridge.CallOpts)
}
