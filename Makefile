...
coverage: clean
	mkdir -p coverage
	gotestsum --format standard-verbose -- -timeout 30m -race -covermode=atomic -coverpkg=./pkg/...,./internal/...,./cmd/... -coverprofile=$(TEMPORAL_COVER_FILE) ./pkg/... ./internal/... ./cmd/...
...
coverage-report: clean
	mkdir -p coverage
	gotestsum --format standard-verbose -- -timeout 30m -race -covermode=atomic -coverpkg=./pkg/...,./internal/...,./cmd/... -coverprofile=$(COVER_FILE) ./pkg/... ./internal/... ./cmd/...
